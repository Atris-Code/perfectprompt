...
interface SaveVideoStyleModalProps {
  onClose: () => void;
  onSave: (name: string) => void;
}

const SaveVideoStyleModal: React.FC<SaveVideoStyleModalProps> = ({ onClose, onSave }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="p-8">
            <h3 id="save-style-modal-title" className="text-2xl font-bold text-gray-900 mb-6">Guardar Estilo de Video</h3>
            <FormInput
                ...
                error={error}
                required
                placeholder="Ej: Look Cinematográfico Neón"
              />
        </div>
...
export default SaveVideoStyleModal;
