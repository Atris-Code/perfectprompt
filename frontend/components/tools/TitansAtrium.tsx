...
// FIX: Chat ahora es un tipo puro de aiShim.ts (proxy backend).
    ...
    <div className="bg-gray-900 p-8 rounded-2xl shadow-lg min-h-full">
        <header className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-400 max-w-3xl mx-auto">
                Selecciona un Titán para acceder a su estación de trabajo, gestionar sus asistentes IA o iniciar una conversación.
            </p>
        </header>
